...
problem: People install apps and forget they exist. Perro's onboarding stalled at photo and health bottlenecks, so new users dropped before reaching their first real in-app action.
